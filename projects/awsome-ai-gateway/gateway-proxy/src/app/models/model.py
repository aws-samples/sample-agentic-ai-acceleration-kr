...
class ModelPricing(Base):
    ...
    # Context-band pricing (migration 0038). threshold NULL = no band (today's behaviour).
    # See ModelPricingSchema for the rule; multipliers derive the long rate from the short.
