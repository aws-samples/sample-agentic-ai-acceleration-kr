...
MODELS = [
    (
        ...
        "openai.gpt-5.6-sol",
        "Codex · GPT-5.6 Sol",
        "Codex -> 123 Bedrock Mantle GPT-5.6 Sol (Ohio, Responses API) — coding / agentic",
    ...
    (
        ...
        "Codex · GPT-5.6 Terra",
        "Codex -> 123 Bedrock Mantle GPT-5.6 Terra (Ohio, Responses API) — balanced",
    ...
    (
        ...
        "openai.gpt-5.6-luna",
        "Codex · GPT-5.6 Luna",
        "Codex -> 123 Bedrock Mantle GPT-5.6 Luna (Ohio, Responses API) — high volume",
