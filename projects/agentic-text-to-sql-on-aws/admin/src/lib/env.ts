...
/** Gateway MCP target 이름 — 도구명 프리픽스 `<target>___<tool>` 구성용. */
...
// ----------------------------------------------------------------------------
// 평가·개선 파이프라인. 전부 optional (미설정 시 화면에 "미구성" 안내).
// ----------------------------------------------------------------------------
...
/** 활성 bundle 포인터 SSM 파라미터명 (승격·롤백의 단일 원천). */
